...
extension Color {
    ...
    struct UI {
        ...
        private let PurlePattern = [#colorLiteral(red: 0.9647058824, green: 0.968627451, blue: 0.9764705882, alpha: 1),#colorLiteral(red: 0.8980392157, green: 0.9058823529, blue: 0.9607843137, alpha: 1),#colorLiteral(red: 0.6509803922, green: 0.6705882353, blue: 0.7411764706, alpha: 1),#colorLiteral(red: 0.4078431373, green: 0.3843137255, blue: 0.5843137255, alpha: 1)]
